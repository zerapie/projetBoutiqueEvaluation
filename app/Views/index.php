			...
			<div role="main" class="main">
								...
								<div class="row">
									...
									<div class="col-md-12 align-self-center order-1">
										<ul class="breadcrumb d-block text-center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
											...
											<li class="active">Full Width Slider</li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="z-index-1 appear-animation" data-appear-animation="fadeInDownShorter" data-appear-animation-delay="500">
					<div class="owl-carousel owl-theme full-width owl-loaded owl-drag owl-carousel-init m-0 mb-4" data-plugin-options="{'items': 1, 'loop': true, 'nav': true, 'dots': false, 'animateOut': 'fadeOut'}">
						<div>
							<img src="<?php echo base_url('img/projects/project-full-width.jpg') ;?>" class="img-fluid" alt="">
						</div>
						<div>
							<img src="<?php echo base_url('img/projects/project-full-width-2.jpg') ;?>" class="img-fluid" alt="">
						</div>
					</div>
				</div>
				...
				<div class="container py-4">
					...
					<div class="row pb-5 pt-2">
						<div class="col-md-7 mb-4 mb-md-0 appear-animation" data-appear-animation="fadeInRightShorter" data-plugin-options="{'accY': -150}">
                            ...
                            <!-- DEBUT - PROJET DETAIL -->
                            <div class="col-md-5 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="600" data-plugin-options="{'accY': -150}">
								...
								<a href="portfolio-single-wide-slider.html">
									<span class="thumb-info thumb-info-lighten thumb-info-no-borders border-radius-0">
										<span class="thumb-info-wrapper border-radius-0">
											<img src="<?php echo base_url('img/projects/project.jpg') ;?>" class="img-fluid border-radius-0" alt="">
						...
						<div class="col-12 col-sm-6 col-lg-3 mb-4">
							<div class="portfolio-item">
								<a href="portfolio-single-wide-slider.html">
									<span class="thumb-info thumb-info-lighten thumb-info-no-borders border-radius-0">
										<span class="thumb-info-wrapper border-radius-0">
											<img src="<?php echo base_url('img/projects/project-2.jpg') ;?>" class="img-fluid border-radius-0" alt="">
											<span class="thumb-info-title">
						...
						<div class="col-12 col-sm-6 col-lg-3 mb-4">
							<div class="portfolio-item">
								<a href="portfolio-single-wide-slider.html">
									<span class="thumb-info thumb-info-lighten thumb-info-no-borders border-radius-0">
										<span class="thumb-info-wrapper border-radius-0">
											<img src="<?php echo base_url('img/projects/project-3.jpg') ;?>" class="img-fluid border-radius-0" alt="">
											<span class="thumb-info-title">
						...
						<div class="col-12 col-sm-6 col-lg-3 mb-4">
							<div class="portfolio-item">
								<a href="portfolio-single-wide-slider.html">
									<span class="thumb-info thumb-info-lighten thumb-info-no-borders border-radius-0">
										<span class="thumb-info-wrapper border-radius-0">
											<img src="<?php echo base_url('img/projects/project-4.jpg') ;?>" class="img-fluid border-radius-0" alt="">
											<span class="thumb-info-title">
