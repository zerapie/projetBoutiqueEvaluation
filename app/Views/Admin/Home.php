									...
									<div class="table-responsive">
										<table class="table table-ecommerce-simple table-striped mb-1">
											...
											<tbody>
												...
												<tr>
													<td><a href="#"><img src="<?php echo base_url('app-assets/img/products/product-2.jpg') ;?>" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
													<td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
													<td>$15</td>
												</tr>
												<tr>
													<td><a href="#"><img src="<?php echo base_url('app-assets/img/products/product-3.jpg') ;?>" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
													<td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
													<td>$15</td>
												</tr>
												<tr>
													<td><a href="#"><img src="<?php echo base_url('app-assets/img/products/product-4.jpg') ;?>" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
													<td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
													<td>$15</td>
												</tr>
												<tr>
													<td><a href="#"><img src="<?php echo base_url('app-assets/img/products/product-5.jpg') ;?>" class="img-fluid" width="45" alt="Porto SmartWatch" /></a></td>
													<td><a href="#" class="font-weight-semibold">Product Short Name Example</a></td>
													<td>$15</td>
												</tr>
											</tbody>
