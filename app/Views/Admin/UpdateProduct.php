	<section role="main" class="content-body content-body-modern mt-0">
		...
		<!-- start: page -->
			<form class="ecommerce-form action-buttons-fixed" action="<?php echo site_url('Admin/AddProduct/update/'.$id) ;?>" enctype='multipart/form-data' method="post">
				<div class="row">
					<div class="col">
						<!-- debut - general info -->
									...
									<div class="col-lg-3-5 col-xl-4-5">
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-lg-7 col-xl-6">
												<input type="text" class="form-control form-control-modern" name="productName" value="<?php echo $ProductUpdate['Product_name']; ?>" required />
											</div>
										</div>
										<!--  Fin  - nom produit -->
										<!-- Debut - description -->
										<div class="form-group row">
											...
											<div class="col-lg-7 col-xl-6">
												<textarea class="form-control form-control-modern" name="productDescription" placeholder="<?php echo $ProductUpdate['Product_description']; ?>"  rows="6"></textarea>
											</div>
										</div>
										<!--  Fin  - description -->
									</div>
											...
											<!-- debut - prix -->
								      		<div class="tab-pane fade show active" id="price" role="tabpanel" aria-labelledby="price-tab">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="regularPrice" value="<?php echo $ProductUpdate['Regular_price']; ?>" />
													</div>
												</div>
												<div class="form-group row align-items-center">
													<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Prix ​​de vente (€)</label>
													<div class="col-lg-7 col-xl-6">
														<input type="text" class="form-control form-control-modern" name="salePrice" value="<?php echo $ProductUpdate['Price']; ?>" />
													</div>
												</div>
								      		</div>
											<!--  fin  - prix -->
											...
											<!-- debut - produit liés -->
								      		<div class="tab-pane fade" id="linked-products" role="tabpanel" aria-labelledby="linked-products-tab">
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<select data-plugin-selectTwo class="form-control form-control-modern" name="Categories" 		value="<?php echo $ProductUpdate['Category_id']; ?>" 		>
															<option value=""></option>
															<?php foreach ($Categories as $Categorie) {  ?>
																<option selected value="<?php echo $Categorie['category_id']; 			?>" ><?php echo $Categorie['category_name'];			?></option>
															<?php } ?>
														</select>
													</div>
												</div>
												<div class="form-group row align-items-center">
													...
													<div class="col-lg-7 col-xl-6">
														<select data-plugin-selectTwo class="form-control form-control-modern" name="SousCategories" 	value="<?php echo $ProductUpdate['Sous_categorie_id']; ?>" 	>
															<option value=""></option>
															<?php foreach ($SousCategories as $SousCategorie) {  ?>
																<option selected value="<?php echo $SousCategorie['sous_categorie_id'];	?>" ><?php echo $SousCategorie['sous_categorie_name'];	?></option>
															<?php } ?>
														</select>
													</div>
												</div>
				...
				<div class="row action-buttons">
					<div class="col-12 col-md-auto">
						<button type="submit" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
							<i class="bx bx-save text-4 mr-2"></i> Update Product
						</button>
					</div>
					...
					<div class="col-12 col-md-auto ml-md-auto mt-3 mt-md-0">
						<a href="<?php echo site_url('Admin/AddProduct/delete/'.$id) ;?>" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1">
