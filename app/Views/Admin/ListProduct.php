										...
										<div class="card-body bg-light">
											<div class="image-frame mb-2">
												<div class="image-frame-wrapper">
													...
													<a href="<?php echo base_url('/admin/ProductDetail/index/'.$Product['Product_id']);?>"><img src="<?php echo base_url('app-assets/img/products/product-1.jpg') ;?>" class="img-fluid" alt="<?php echo $Product['Product_photo_name']; ?>" /></a>
												</div>
											</div>
											...
											<h4 class="text-4 line-height-2 mt-0 mb-2"><a href="<?php echo base_url('/admin/ProductDetail/index/'.$Product['Product_id']);?>" class="ecommerce-sidebar-link text-color-dark text-color-hover-primary text-decoration-none"><?php echo $Product['Product_name']; ?></a></h4>
